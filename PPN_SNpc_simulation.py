...
class PPN_SNpc():
    ...
    def __init__(self, parameters, rng):
        ...
        self.Ws = {
            ...
            "NAc_SNpci_1": np.ones(parameters.N["SNpc"]) * parameters.Matrices_scalars["NAc_1_SNpci_1"],
            "DMS_SNpci_2": np.ones(parameters.N["SNpc"]) * parameters.Matrices_scalars["DMS_1_SNpci_2"]
            }
